...
const translations = {
  UA: {
    ...
    calculator: {
      ...
      leads: "Скільки запитів отримуєте?",
      deals: "Скільки угод закриваєте зараз?",
      comm: "Середня комісія",
      rentPrice: "Вартість оренди",
      gain: "Додатковий прибуток:",
      loss: "Ви втрачаєте зараз:",
      lossExplain: "Це 30% ваших лідів, які пишуть вночі та не отримують відповіді вчасно.",
      roi: "Окупність",
      sale: "Продаж",
      rent: "Оренда",
      ...
      savedLeads: "Додаткові угоди з AI",
      perMonth: "/міс",
      aiAdmin: "AI-адміністратор",
      clients: "угод",
      yourProfit: "Ваш новий прибуток",
      growthLabel: "Це на",
      growthSuffix: "більше",
      currentResult: "Поточний результат",
      growthDeals: "Зростання угод",
      dealsArrow: "угод",
  ...
  EN: {
    ...
    pricing: {
      ...
      tier1F1: "2 messengers (Insta/TG)",
      tier1F2: "5-second response",
      tier1F3: "Basic qualification",
      tier1F4: "Lead flow setup",
      tier2Name: "пакет \"Екосистема\"",
      tier2Price: "$2,299",
      tier2Freq: "+ $200/mo",
      tier2F1: "Omnichannel",
      tier2F2: "CRM synchronization",
      tier2F3: "Weekly maintenance",
      tier2F4: "Viewing calendar",
      tier3Name: "пакет \"Потужність\"",
      tier3Price: "$4,999",
      tier3Freq: "+ $500/mo",
      tier3F1: "Everything in \"Екосистема\"",
    ...
    calculator: {
      ...
      leads: "How many inquiries do you get?",
      deals: "How many deals do you close now?",
      comm: "Average commission",
      rentPrice: "Rent price",
      gain: "Extra Profit:",
      loss: "You're losing now:",
      lossExplain: "That's 30% of your leads who write at night and don't get a timely response.",
      roi: "Payback",
      sale: "Sale",
      rent: "Rent",
      ...
      savedLeads: "Extra deals with AI",
      perMonth: "/mo",
      aiAdmin: "AI Admin",
      clients: "deals",
      yourProfit: "Your new profit",
      growthLabel: "That's",
      growthSuffix: "more",
      currentResult: "Current result",
      growthDeals: "Deals growth",
      dealsArrow: "deals",
  ...
  RO: {
    ...
    pricing: {
      ...
      tier1F1: "2 messengeri (Insta/TG)",
      tier1F2: "Răspuns în 5 secunde",
      tier1F3: "Calificare de bază",
      tier1F4: "Configurare flux lead-uri",
      tier2Name: "пакет \"Екосистема\"",
      tier2Price: "$2.299",
      tier2Freq: "+ $200/lună",
      tier2F1: "Omnicanal",
      tier2F2: "Sincronizare CRM",
      tier2F3: "Întreținere săptămânală",
      tier2F4: "Calendar vizionări",
      tier3Name: "пакет \"Потужність\"",
      tier3Price: "$4.999",
      tier3Freq: "+ $500/lună",
      tier3F1: "Tot din \"Екосистема\"",
    ...
    calculator: {
      ...
      leads: "Câte cereri primești?",
      deals: "Câte tranzacții închizi acum?",
      comm: "Comision mediu",
      rentPrice: "Preț chirie",
      gain: "Profit suplimentar:",
      loss: "Pierzi acum:",
      lossExplain: "Sunt 30% din lead-urile tale care scriu noaptea și nu primesc răspuns la timp.",
      roi: "Amortizare",
      sale: "Vânzare",
      rent: "Închiriere",
      ...
      savedLeads: "Tranzacții extra cu AI",
      perMonth: "/lună",
      aiAdmin: "Admin AI",
      clients: "tranzacții",
      yourProfit: "Noul tău profit",
      growthLabel: "Cu",
      growthSuffix: "mai mult",
      currentResult: "Rezultat curent",
      growthDeals: "Creștere tranzacții",
      dealsArrow: "tranzacții",
